    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-4">
      ...
      >
        {filteredOrders.slice(0, visibleOrdersCount).map((order) => (
          <div
            key={order.id}
            className="border border-white-500 rounded-lg p-4 sm:p-6 bg-white-50 hover:shadow-md transition-shadow duration-200"
          >
            {/* Order Header */}
            ...
            <div className="flex flex-col sm:flex-row gap-2 mt-4 pt-4 border-t border-white-500">
              <button className="text-sm text-black-900 bg-white-50 border border-white-500 px-4 py-2 rounded-lg font-medium hover:bg-white-400 transition-colors text-center">
                View Order Details
              </button>
