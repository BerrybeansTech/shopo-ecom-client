  ...
  return (
    ...
    <div>
      ...
      <p className="text-sm text-gray-900 font-medium">
        {address.customer?.name || user.name}
      </p>
    </div>
  </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  rows="3"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-black outline-none text-sm text-gray-900 resize-none"
