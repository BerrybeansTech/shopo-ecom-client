...
export default function PrivacyPolicy() {
  return (
    <Layout childrenClasses="pt-0 pb-0">
      <div className="privacy-policy-page w-full bg-white pb-[50px]">
              ...
              <div>
                ...
                <ul className="list-disc ml-11">
                  <li className="text-[15px] text-qgraytwo leading-7">
                    <strong className="text-qblack">Cookies</strong> are data files that are placed on your device or computer and often include an anonymous unique identifier. For more information about cookies, and how to disable cookies, visit http://www.allaboutcookies.org.
                  </li>
                  <li className="text-[15px] text-qgraytwo leading-7">
                    <strong className="text-qblack">Log files</strong>  track actions occurring on the Site, and collect data including your IP address, browser type, Internet service provider, referring/exit pages, and date/time stamps.
                  </li>
                  <li className="text-[15px] text-qgraytwo leading-7">
                    <strong className="text-qblack">Web beacons, tags,</strong> and <strong className="text-qblack">pixels</strong> are electronic files used to record information about how you browse the Site.
                  </li>
                </ul>
              </div>
            </div>
