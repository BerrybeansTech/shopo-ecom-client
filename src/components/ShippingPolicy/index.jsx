...
export default function ShippingPolicy() {
  return (
    <Layout childrenClasses="pt-0 pb-0">
      <div className="shipping-policy-page w-full bg-white pb-[50px]">
            ...
            <div className="container-x mx-auto">
                ...
                <div className="content-item w-full">
                    ...
                    <p className="text-[15px] text-qgraytwo leading-7">
                        ...
                        <br />
                        <br />
                        In case you receive a damaged / defective product, please notify us within 24 hours of delivery. Additionally, kindly email us a photograph of the damaged or defective product to support@thebearhouse.com
                        <br />
                        <br />
                        In the unlikely event that you receive an wrong product, empty parcel or a missing product, we would request you to reach out to our customer support team for assistance within 48 hours of the package being delivered. We will be requiring anunpacking video of the parcel for us to process the request further. Please note that insufficient evidence or visible signs of tampering with the packet may result in your claim not being honored. In all such cases, the brandreserves the right to take the final decision.
                    </p>
                </div>
            </div>
        </div>
